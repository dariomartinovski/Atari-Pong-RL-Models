...
BASE_MODEL_PATH = "trained_models/PongNoFrameskip-v4-best"
FPS = 25
...
if __name__ == "__main__":
    ...
    net.load_state_dict(torch.load(BASE_MODEL_PATH + '-' + args.network + '.dat', map_location=lambda storage, loc: storage))
